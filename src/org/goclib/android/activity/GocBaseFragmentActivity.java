...
public abstract class GocBaseFragmentActivity extends FragmentActivity
	...
	public Fragment getCurrentFragment(){
		return getTabHost() == null?null:getSupportFragmentManager().findFragmentByTag(getTabHost().getCurrentTabTag());
	}
}
