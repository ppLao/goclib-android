	...
	protected void prepare(TypedArray ta){
		try{
			...
			_rightEntity
				...
				.setTextSize(ta.getDimensionPixelOffset(org.goclib.android.R.styleable.TitleBar_goclib_titlebar_right_text_size, 16))
			...
			_leftEntity
				...
				.setTextSize(ta.getDimensionPixelOffset(org.goclib.android.R.styleable.TitleBar_goclib_titlebar_left_text_size, 16))
			...
			//LogUtil.trace(ta.getDimensionPixelOffset(org.goclib.android.R.styleable.TitleBar_goclib_titlebar_title_text_size, 18)+","+ta.getDimension(org.goclib.android.R.styleable.TitleBar_goclib_titlebar_title_text_size, 18),this);
			_titleEntity
			.setEnabled(ta.getBoolean(org.goclib.android.R.styleable.TitleBar_goclib_titlebar_title_enabled, true))
				.setTextSize(ta.getDimensionPixelOffset(org.goclib.android.R.styleable.TitleBar_goclib_titlebar_title_text_size, 18))
